...
public class CityTester {
	...
	public static void main(String[] args) {
		...
		Bellevue.populateCity(new Building("McDonald's"));
		Bellevue.populateCity(new Person ("Phone Number Tester", 25, 1234567));
		
		//Test Teacher and Police Constructors
		Bellevue.populateCity(new Teacher("Mr. Meaty", 4));
		Bellevue.populateCity(new Police(40,"Mr. Sheriff",20));
		
		//Test Kid Constructors
